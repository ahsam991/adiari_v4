    ...
    <div class="flex h-screen overflow-hidden">
        <aside class="w-64 bg-gray-900 text-white flex-shrink-0">
            ...
            <nav class="mt-6 px-4 space-y-2">
                ...
                <a href="/manager" class="<?= $nav('/manager') ?> mt-4"><span class="material-symbols-outlined mr-3">store</span>Manager</a>
            ...
            <main class="p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        ...
                        <div class="text-3xl font-bold text-gray-900 mt-1"><?= number_format($stats['users'] ?? 0) ?></div>
                    </div>
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        <h3 class="text-sm font-medium text-gray-500">Products</h3>
                        <div class="text-3xl font-bold text-gray-900 mt-1"><?= number_format($stats['products'] ?? 0) ?></div>
                    </div>
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        <h3 class="text-sm font-medium text-gray-500">Today's Orders</h3>
                        <div class="text-3xl font-bold text-gray-900 mt-1"><?= number_format($stats['today_orders'] ?? 0) ?></div>
                    </div>
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        <h3 class="text-sm font-medium text-gray-500">Today's Revenue</h3>
                        <div class="text-3xl font-bold text-gray-900 mt-1">¥<?= number_format($stats['today_revenue'] ?? 0) ?></div>
                    </div>
                </div>
            </main>
        </div>
