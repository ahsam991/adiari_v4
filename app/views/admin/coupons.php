...
<div class="bg-gray-100 min-h-screen">
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 overflow-auto">
            <header class="bg-white shadow-sm p-6"><h1 class="text-2xl font-bold text-gray-900">Coupons</h1></header>
            <main class="p-8">
                ...
                <div class="bg-white rounded-xl shadow-sm p-8 border border-gray-100 text-center text-gray-500">Coupon management can be extended with discount codes and rules.</div>
            </main>
        </div>
    </div>
</div>
