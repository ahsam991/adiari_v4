                ...
                <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                    <form action="/manager/product/<?= $product['id'] ?>/update" method="POST" enctype="multipart/form-data" class="p-8">
                        ...
                        <div class="mb-6">
                            ...
                            <!-- Current Image Preview with Change Option -->
                            <div class="flex items-start space-x-6">
                                <?php if (!empty($product['primary_image'])): ?>
                                    <div class="flex-shrink-0">
                                        <p class="text-xs text-gray-500 mb-2">Current Image:</p>
                                        <img src="<?= htmlspecialchars($product['primary_image']) ?>" alt="Current Product Image" class="h-32 w-32 object-cover rounded-lg shadow-sm border border-gray-200">
                                    </div>
                                <?php endif; ?>
                                ...
                                <div class="flex-grow">
                                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-green-500 transition cursor-pointer bg-gray-50" onclick="document.getElementById('primary_image').click()">
                                        <div class="space-y-1 text-center">
                                            ...
                                            <div class="flex toext-sm text-gray-600 justify-center">
